...
![](http://resources.chenjianhui.site/2019-02-23-home-pic.png)
<!-- more -->
...
![整体目录结构](http://resources.chenjianhui.site/ServerFrontSeparate-root-folder.png)

&emsp;&emsp;打包后的目录主要分为三块，如下所示
![项目打包目录](http://resources.chenjianhui.site/ServerFrontSeparate-dist-folder.png)
...
![前端打包配置修改](http://resources.chenjianhui.site/ServerFrontSeparate-front-build-config.png)
...
![](http://resources.chenjianhui.site/ServerFrontSeparate-front-proxy-config.png)
